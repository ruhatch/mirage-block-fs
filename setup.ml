...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0efe979f81a6a77baf954fef8ab2d9d9) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("inode_index_tests",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$inode_index_tests", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("inode_tests",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$inode_tests", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("bitarray_tests",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$bitarray_tests", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("free_map_tests",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$free_map_tests", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/ruhatch/mirage-block-fs";
          synopsis =
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("mirage-btrees", None);
                   ...
                   {
                      lib_modules =
                        ["Fs"; "InodeIndex"; "Inode"; "FreeMap"; "Bitarray"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "mirage-block-fs";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "fsTests.ml"});
               Executable
                 ({
                     cs_name = "inode_index_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "inodeIndexTests.ml"});
               Executable
                 ({
                     cs_name = "inode_tests";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "inodeTests.ml"});
               Executable
                 ({
                     cs_name = "bitarray_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "bitarrayTests.ml"});
               Executable
                 ({
                     cs_name = "free_map_tests";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "free_map_tests.ml"});
               Test
                 ({
                     cs_name = "fs_tests";
                     cs_data = PropList.Data.create ();
                 ...
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "inode_index_tests"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "inode_tests"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "bitarray_tests"
                        ]
                   });
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ExternalTool "ocamlbuild";
                           InternalExecutable "free_map_tests"
                        ]
                   })
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "^úe@\149RLØNí/\131\1271%Í";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
